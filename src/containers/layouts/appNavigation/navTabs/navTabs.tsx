...
import { StyledTabsList, StyledTab } from "./navStyles";
import OccasionsMenu from "./megaMenu";
...
const NavTabs: React.FC<TabMenusProps> = ({ navMenus }) => {
  const [open, setOpen] = React.useState(false);
  const navMenuItems = useReactiveVar(reactiveNavMenus);
