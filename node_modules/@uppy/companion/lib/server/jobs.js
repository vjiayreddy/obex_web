...
function runPeriodicPing({ urls, payload, requestTimeout }) {
    return __awaiter(this, void 0, void 0, function* () {
        // Run requests in parallel
        yield Promise.all(urls.map((url) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield got.post(url, { json: payload, timeout: { request: requestTimeout } });
            }
            catch (err) {
...
exports.startPeriodicPingJob = ({ urls, interval = 60000, count, staticPayload = {}, version, processId }) => __awaiter(this, void 0, void 0, function* () {
    if (urls.length === 0)
        return;
    ...
    yield sleep(delayBySec);
    let i = 0;
    const intervalRef = setInterval(() => __awaiter(this, void 0, void 0, function* () {
        // Used for testing:
        ...
        try {
            requesting = true;
            const payload = Object.assign({ version, processId, service: 'companion' }, staticPayload);
            yield runPeriodicPing({ urls, payload, requestTimeout });
        }
        finally {
            requesting = false;
        }
