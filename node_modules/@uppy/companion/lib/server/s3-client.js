...
module.exports = (companionOptions) => {
    ...
    if (companionOptions.s3) {
        ...
        if (s3.useAccelerateEndpoint && s3.bucket != null) {
            s3ClientOptions = Object.assign(Object.assign({}, s3ClientOptions), { useAccelerateEndpoint: true, s3BucketEndpoint: true, 
        ...
        s3ClientOptions = Object.assign(Object.assign({}, s3ClientOptions), rawClientOptions);
        ...
        if (s3.key && s3.secret && !s3ClientOptions.credentials) {
            s3ClientOptions.credentials = new AWS.Credentials(s3.key, s3.secret, s3.sessionToken);
        }
